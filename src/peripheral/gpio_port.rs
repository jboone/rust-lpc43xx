...
impl Mpin {
    ...
    # [ doc = "Masked port register (bit 0 = GPIOm[0], bit 1 = GPIOm[1], ..., bit 31 = GPIOm[31]). 0 = pin is LOW and/or the corresponding bit in the MASK register is 1. 1 = Read: pin is HIGH and the corresponding bit in the MASK register is 0." ]
